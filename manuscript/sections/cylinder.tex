...
$\sim\!\num{0.003}$, within sample noise). The native-aware carve beats the plain count at every
setting. Full result and the checklist in \texttt{docs/CYLINDER\_PARAMS.md}.
