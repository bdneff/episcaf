...
top-\num{10} for C3) assembly emits \num{15324} episcaf constructs, each with a unique
\texttt{library\_member} and \texttt{design\_ID}, all \num{103} residues; the \num{21759} minibinders are
then folded in for the combined \num{37083}-row file.
...
oligo, so the final step converts all \num{37083} 103-mers of the combined library (the \num{15324}
