...
variant-transcending antibodies. In \texttt{8VDL} that surface is the single contiguous stretch chain~C
\numrange{651}{670} (\texttt{FDSFFFQVIYKFNEGEAKWN}), with functional hotspots \texttt{F655}, \texttt{F656},
\texttt{E666}. Because the crystal also contains the cognate C7 antibody (chains H/L), this is a
known-antibody target and the real clash term applies, exactly as for C1/C2.
