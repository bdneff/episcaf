...
logged and skipped. In the current build this affects \num{89} of \num{1140} base designs
(\SI{7.8}{\percent}) --- scaffolds too small or too epitope-dense to place four hexamers each
$\ge\!4$ residues from the epitope --- so the \texttt{scaffoldMutX4} arm covers \num{1051} of the
\num{1140} bases while the island-alanine arms cover all of them.
