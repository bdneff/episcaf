...
logged and skipped. In the current build this affects \num{93} of \num{1120} base designs
(\SI{8.3}{\percent}) --- scaffolds too small or too epitope-dense to place four hexamers each
$\ge\!4$ residues from the epitope --- so the \texttt{scaffoldMutX4} arm covers \num{1027} of the
\num{1120} bases while the island-alanine arms cover all of them.
